...
export class ApiConstruct extends Construct {
  ...
  constructor(parent: Construct, name: string, props: ApiConstructProps) {
    ...
    apiGatewayPushToCloudWatchRole.addManagedPolicy(iam.ManagedPolicy.fromAwsManagedPolicyName('service-role/AmazonAPIGatewayPushToCloudWatchLogs'));
    ...
    const applicationAdminServiceExecutionPermission =
      new cdk.aws_lambda.CfnPermission(
        ...
        "ApplicationAdminServiceExecutionPermission",
        {
          ...
          sourceArn: `arn:${cdk.Aws.PARTITION}:execute-api:${cdk.Aws.REGION}:${cdk.Aws.ACCOUNT_ID}:${gameAnalyticsApi.restApiId}/*/*`,
        }
      );
