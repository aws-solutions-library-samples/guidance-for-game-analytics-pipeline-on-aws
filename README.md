...
- `DEMO`
  - *Description:* This is a placeholder for future synthetic event data for demonstration purposes. The default value is set to `false`, as this component has not yet been implemented.
  - *Type:* Boolean
  - *Example:* `false`
- `accounts`
