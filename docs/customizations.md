...
- SQL views must be created via `POST /redshift/setup` (or equivalent) before data appears in the dashboard — the dashboard deploys successfully with empty visuals until views exist
